...
`)+`
`+u);const x=M+p+a,v=M+u+o,R=_o(r,r.VERTEX_SHADER,x),B=_o(r,r.FRAGMENT_SHADER,v);r.attachShader(E,R),r.attachShader(E,B),t.index0AttributeName!==void 0?r.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function w(b){if(i.debug.checkShaderErrors){const W=r.getProgramInfoLog(E).trim(),k=r.getShaderInfoLog(R).trim(),z=r.getShaderInfoLog(B).trim();let J=!0,H=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,E,R,B);else{const Y=vo(r,R,"vertex"),P=vo(r,B,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
...
}`;function rp(i,e,t){let n=new ol;const r=new qe,s=new qe,a=new tt,o=new MA({depthPacking:Ec}),c=new BA,l={},A=t.maxTextureSize,h={[In]:Bt,[Bt]:In,[Vt]:Vt},d=new Kt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:np,fragmentShader:ip}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Zt;g.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new Xt(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Oo;let u=this.type;this.render=function(B,w,L){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||B.length===0)return;const I=i.getRenderTarget(),C=i.getActiveCubeFace(),b=i.getActiveMipmapLevel(),W=i.state;W.setBlending(Cn),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const k=u!==on&&this.type===on,z=u===on&&this.type!==on;for(let J=0,H=B.length;J<H;J++){const Y=B[J],P=Y.shadow;if(P===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(P.autoUpdate===!1&&P.needsUpdate===!1)continue;r.copy(P.mapSize);const ne=P.getFrameExtents();if(r.multiply(ne),s.copy(P.mapSize),(r.x>A||r.y>A)&&(r.x>A&&(s.x=Math.floor(A/ne.x),r.x=s.x*ne.x,P.mapSize.x=s.x),r.y>A&&(s.y=Math.floor(A/ne.y),r.y=s.y*ne.y,P.mapSize.y=s.y)),P.map===null||k===!0||z===!0){const pe=this.type!==on?{minFilter:Ut,magFilter:Ut}:{};P.map!==null&&P.map.dispose(),P.map=new qn(r.x,r.y,pe),P.map.texture.name=Y.name+".shadowMap",P.camera.updateProjectionMatrix()}i.setRenderTarget(P.map),i.clear();const le=P.getViewportCount();for(let pe=0;pe<le;pe++){const he=P.getViewport(pe);a.set(s.x*he.x,s.y*he.y,s.x*he.z,s.y*he.w),W.viewport(a),P.updateMatrices(Y,pe),n=P.getFrustum(),v(w,L,P.camera,Y,this.type)}P.isPointLightShadow!==!0&&this.type===on&&M(P,L),P.needsUpdate=!1}u=this.type,p.needsUpdate=!1,i.setRenderTarget(I,C,b)};function M(B,w){const L=e.update(E);d.defines.VSM_SAMPLES!==B.blurSamples&&(d.defines.VSM_SAMPLES=B.blurSamples,f.defines.VSM_SAMPLES=B.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),B.mapPass===null&&(B.mapPass=new qn(r.x,r.y)),d.uniforms.shadow_pass.value=B.map.texture,d.uniforms.resolution.value=B.mapSize,d.uniforms.radius.value=B.radius,i.setRenderTarget(B.mapPass),i.clear(),i.renderBufferDirect(w,null,L,d,E,null),f.uniforms.shadow_pass.value=B.mapPass.texture,f.uniforms.resolution.value=B.mapSize,f.uniforms.radius.value=B.radius,i.setRenderTarget(B.map),i.clear(),i.renderBufferDirect(w,null,L,f,E,null)}function x(B,w,L,I){let C=null;const b=L.isPointLight===!0?B.customDistanceMaterial:B.customDepthMaterial;if(b!==void 0)C=b;else if(C=L.isPointLight===!0?c:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const W=C.uuid,k=w.uuid;let z=l[W];z===void 0&&(z={},l[W]=z);let J=z[k];J===void 0&&(J=C.clone(),z[k]=J,w.addEventListener("dispose",R)),C=J}if(C.visible=w.visible,C.wireframe=w.wireframe,I===on?C.side=w.shadowSide!==null?w.shadowSide:w.side:C.side=w.shadowSide!==null?w.shadowSide:h[w.side],C.alphaMap=w.alphaMap,C.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,C.map=w.map,C.clipShadows=w.clipShadows,C.clippingPlanes=w.clippingPlanes,C.clipIntersection=w.clipIntersection,C.displacementMap=w.displacementMap,C.displacementScale=w.displacementScale,C.displacementBias=w.displacementBias,C.wireframeLinewidth=w.wireframeLinewidth,C.linewidth=w.linewidth,L.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const W=i.properties.get(C);W.light=L}return C}function v(B,w,L,I,C){if(B.visible===!1)return;if(B.layers.test(w.layers)&&(B.isMesh||B.isLine||B.isPoints)&&(B.castShadow||B.receiveShadow&&C===on)&&(!B.frustumCulled||n.intersectsObject(B))){B.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,B.matrixWorld);const k=e.update(B),z=B.material;if(Array.isArray(z)){const J=k.groups;for(let H=0,Y=J.length;H<Y;H++){const P=J[H],ne=z[P.materialIndex];if(ne&&ne.visible){const le=x(B,ne,I,C);B.onBeforeShadow(i,B,w,L,k,le,P),i.renderBufferDirect(L,null,k,le,B,P),B.onAfterShadow(i,B,w,L,k,le,P)}}}else if(z.visible){const J=x(B,z,I,C);B.onBeforeShadow(i,B,w,L,k,J,null),i.renderBufferDirect(L,null,k,J,B,null),B.onAfterShadow(i,B,w,L,k,J,null)}}const W=B.children;for(let k=0,z=W.length;k<z;k++)v(W[k],w,L,I,C)}function R(B){B.target.removeEventListener("dispose",R);for(const L in l){const I=l[L],C=B.target.uuid;C in I&&(I[C].dispose(),delete I[C])}}}const sp={[bs]:Rs,[Ds]:Fs,[Us]:Qs,[Ei]:Ls,[Rs]:bs,[Fs]:Ds,[Qs]:Us,[Ls]:Ei};function ap(i,e){function t(){let T=!1;const ce=new tt;let $=null;const fe=new tt(0,0,0,0);return{setMask:function(ee){$!==ee&&!T&&(i.colorMask(ee,ee,ee,ee),$=ee)},setLocked:function(ee){T=ee},setClear:function(ee,X,ge,Ue,je){je===!0&&(ee*=Ue,X*=Ue,ge*=Ue),ce.set(ee,X,ge,Ue),fe.equals(ce)===!1&&(i.clearColor(ee,X,ge,Ue),fe.copy(ce))},reset:function(){T=!1,$=null,fe.set(-1,0,0,0)}}}function n(){let T=!1,ce=!1,$=null,fe=null,ee=null;return{setReversed:function(X){if(ce!==X){const ge=e.get("EXT_clip_control");X?ge.clipControlEXT(ge.LOWER_LEFT_EXT,ge.ZERO_TO_ONE_EXT):ge.clipControlEXT(ge.LOWER_LEFT_EXT,ge.NEGATIVE_ONE_TO_ONE_EXT),ce=X;const Ue=ee;ee=null,this.setClear(Ue)}},getReversed:function(){return ce},setTest:function(X){X?ie(i.DEPTH_TEST):Ce(i.DEPTH_TEST)},setMask:function(X){$!==X&&!T&&(i.depthMask(X),$=X)},setFunc:function(X){if(ce&&(X=sp[X]),fe!==X){switch(X){case bs:i.depthFunc(i.NEVER);break;case Rs:i.depthFunc(i.ALWAYS);break;case Ds:i.depthFunc(i.LESS);break;case Ei:i.depthFunc(i.LEQUAL);break;case Us:i.depthFunc(i.EQUAL);break;case Ls:i.depthFunc(i.GEQUAL);break;case Fs:i.depthFunc(i.GREATER);break;case Qs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}fe=X}},setLocked:function(X){T=X},setClear:function(X){ee!==X&&(ce&&(X=1-X),i.clearDepth(X),ee=X)},reset:function(){T=!1,$=null,fe=null,ee=null,ce=!1}}}function r(){let T=!1,ce=null,$=null,fe=null,ee=null,X=null,ge=null,Ue=null,je=null;return{setTest:function(Xe){T||(Xe?ie(i.STENCIL_TEST):Ce(i.STENCIL_TEST))},setMask:function(Xe){ce!==Xe&&!T&&(i.stencilMask(Xe),ce=Xe)},setFunc:function(Xe,Ot,jt){($!==Xe||fe!==Ot||ee!==jt)&&(i.stencilFunc(Xe,Ot,jt),$=Xe,fe=Ot,ee=jt)},setOp:function(Xe,Ot,jt){(X!==Xe||ge!==Ot||Ue!==jt)&&(i.stencilOp(Xe,Ot,jt),X=Xe,ge=Ot,Ue=jt)},setLocked:function(Xe){T=Xe},setClear:function(Xe){je!==Xe&&(i.clearStencil(Xe),je=Xe)},reset:function(){T=!1,ce=null,$=null,fe=null,ee=null,X=null,ge=null,Ue=null,je=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let A={},h={},d=new WeakMap,f=[],g=null,E=!1,p=null,u=null,M=null,x=null,v=null,R=null,B=null,w=new ze(0,0,0),L=0,I=!1,C=null,b=null,W=null,k=null,z=null;const J=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,Y=0;const P=i.getParameter(i.VERSION);P.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(P)[1]),H=Y>=1):P.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(P)[1]),H=Y>=2);let ne=null,le={};const pe=i.getParameter(i.SCISSOR_BOX),he=i.getParameter(i.VIEWPORT),we=new tt().fromArray(pe),O=new tt().fromArray(he);function j(T,ce,$,fe){const ee=new Uint8Array(4),X=i.createTexture();i.bindTexture(T,X),i.texParameteri(T,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(T,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ge=0;ge<$;ge++)T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY?i.texImage3D(ce,0,i.RGBA,1,1,fe,0,i.RGBA,i.UNSIGNED_BYTE,ee):i.texImage2D(ce+ge,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ee);return X}const oe={};oe[i.TEXTURE_2D]=j(i.TEXTURE_2D,i.TEXTURE_2D,1),oe[i.TEXTURE_CUBE_MAP]=j(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),oe[i.TEXTURE_2D_ARRAY]=j(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),oe[i.TEXTURE_3D]=j(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ie(i.DEPTH_TEST),a.setFunc(Ei),We(!1),Ze(wa),ie(i.CULL_FACE),y(Cn);function ie(T){A[T]!==!0&&(i.enable(T),A[T]=!0)}function Ce(T){A[T]!==!1&&(i.disable(T),A[T]=!1)}function Oe(T,ce){return h[T]!==ce?(i.bindFramebuffer(T,ce),h[T]=ce,T===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ce),T===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ce),!0):!1}function ye(T,ce){let $=f,fe=!1;if(T){$=d.get(ce),$===void 0&&($=[],d.set(ce,$));const ee=T.textures;if($.length!==ee.length||$[0]!==i.COLOR_ATTACHMENT0){for(let X=0,ge=ee.length;X<ge;X++)$[X]=i.COLOR_ATTACHMENT0+X;$.length=ee.length,fe=!0}}else $[0]!==i.BACK&&($[0]=i.BACK,fe=!0);fe&&i.drawBuffers($)}function it(T){return g!==T?(i.useProgram(T),g=T,!0):!1}const rt={[Fn]:i.FUNC_ADD,[Vl]:i.FUNC_SUBTRACT,[Wl]:i.FUNC_REVERSE_SUBTRACT};rt[ql]=i.MIN,rt[Xl]=i.MAX;const Ve={[Yl]:i.ZERO,[Jl]:i.ONE,[Kl]:i.SRC_COLOR,[ws]:i.SRC_ALPHA,[nc]:i.SRC_ALPHA_SATURATE,[ec]:i.DST_COLOR,[jl]:i.DST_ALPHA,[Zl]:i.ONE_MINUS_SRC_COLOR,[Ts]:i.ONE_MINUS_SRC_ALPHA,[tc]:i.ONE_MINUS_DST_COLOR,[$l]:i.ONE_MINUS_DST_ALPHA,[ic]:i.CONSTANT_COLOR,[rc]:i.ONE_MINUS_CONSTANT_COLOR,[sc]:i.CONSTANT_ALPHA,[ac]:i.ONE_MINUS_CONSTANT_ALPHA};function y(T,ce,$,fe,ee,X,ge,Ue,je,Xe){if(T===Cn){E===!0&&(Ce(i.BLEND),E=!1);return}if(E===!1&&(ie(i.BLEND),E=!0),T!==zl){if(T!==p||Xe!==I){if((u!==Fn||v!==Fn)&&(i.blendEquation(i.FUNC_ADD),u=Fn,v=Fn),Xe)switch(T){case di:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ta:i.blendFunc(i.ONE,i.ONE);break;case ba:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ra:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",T);break}else switch(T){case di:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ta:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ba:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ra:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",T);break}M=null,x=null,R=null,B=null,w.set(0,0,0),L=0,p=T,I=Xe}return}ee=ee||ce,X=X||$,ge=ge||fe,(ce!==u||ee!==v)&&(i.blendEquationSeparate(rt[ce],rt[ee]),u=ce,v=ee),($!==M||fe!==x||X!==R||ge!==B)&&(i.blendFuncSeparate(Ve[$],Ve[fe],Ve[X],Ve[ge]),M=$,x=fe,R=X,B=ge),(Ue.equals(w)===!1||je!==L)&&(i.blendColor(Ue.r,Ue.g,Ue.b,je),w.copy(Ue),L=je),p=T,I=!1}function Et(T,ce){T.side===Vt?Ce(i.CULL_FACE):ie(i.CULL_FACE);let $=T.side===Bt;ce&&($=!$),We($),T.blending===di&&T.transparent===!1?y(Cn):y(T.blending,T.blendEquation,T.blendSrc,T.blendDst,T.blendEquationAlpha,T.blendSrcAlpha,T.blendDstAlpha,T.blendColor,T.blendAlpha,T.premultipliedAlpha),a.setFunc(T.depthFunc),a.setTest(T.depthTest),a.setMask(T.depthWrite),s.setMask(T.colorWrite);const fe=T.stencilWrite;o.setTest(fe),fe&&(o.setMask(T.stencilWriteMask),o.setFunc(T.stencilFunc,T.stencilRef,T.stencilFuncMask),o.setOp(T.stencilFail,T.stencilZFail,T.stencilZPass)),Ge(T.polygonOffset,T.polygonOffsetFactor,T.polygonOffsetUnits),T.alphaToCoverage===!0?ie(i.SAMPLE_ALPHA_TO_COVERAGE):Ce(i.SAMPLE_ALPHA_TO_COVERAGE)}function We(T){C!==T&&(T?i.frontFace(i.CW):i.frontFace(i.CCW),C=T)}function Ze(T){T!==Gl?(ie(i.CULL_FACE),T!==b&&(T===wa?i.cullFace(i.BACK):T===kl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Ce(i.CULL_FACE),b=T}function _e(T){T!==W&&(H&&i.lineWidth(T),W=T)}function Ge(T,ce,$){T?(ie(i.POLYGON_OFFSET_FILL),(k!==ce||z!==$)&&(i.polygonOffset(ce,$),k=ce,z=$)):Ce(i.POLYGON_OFFSET_FILL)}function Se(T){T?ie(i.SCISSOR_TEST):Ce(i.SCISSOR_TEST)}function Fe(T){T===void 0&&(T=i.TEXTURE0+J-1),ne!==T&&(i.activeTexture(T),ne=T)}function At(T,ce,$){$===void 0&&(ne===null?$=i.TEXTURE0+J-1:$=ne);let fe=le[$];fe===void 0&&(fe={type:void 0,texture:void 0},le[$]=fe),(fe.type!==T||fe.texture!==ce)&&(ne!==$&&(i.activeTexture($),ne=$),i.bindTexture(T,ce||oe[T]),fe.type=T,fe.texture=ce)}function S(){const T=le[ne];T!==void 0&&T.type!==void 0&&(i.bindTexture(T.type,null),T.type=void 0,T.texture=void 0)}function m(){try{i.compressedTexImage2D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Q(){try{i.compressedTexImage3D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function q(){try{i.texSubImage2D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function K(){try{i.texSubImage3D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function V(){try{i.compressedTexSubImage2D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function ve(){try{i.compressedTexSubImage3D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function ae(){try{i.texStorage2D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Ee(){try{i.texStorage3D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Ie(){try{i.texImage2D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Z(){try{i.texImage3D(...arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function ue(T){we.equals(T)===!1&&(i.scissor(T.x,T.y,T.z,T.w),we.copy(T))}function Te(T){O.equals(T)===!1&&(i.viewport(T.x,T.y,T.z,T.w),O.copy(T))}function Be(T,ce){let $=l.get(ce);$===void 0&&($=new WeakMap,l.set(ce,$));let fe=$.get(T);fe===void 0&&(fe=i.getUniformBlockIndex(ce,T.name),$.set(T,fe))}function re(T,ce){const fe=l.get(ce).get(T);c.get(ce)!==fe&&(i.uniformBlockBinding(ce,fe,T.__bindingPointIndex),c.set(ce,fe))}function De(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),A={},ne=null,le={},h={},d=new WeakMap,f=[],g=null,E=!1,p=null,u=null,M=null,x=null,v=null,R=null,B=null,w=new ze(0,0,0),L=0,I=!1,C=null,b=null,W=null,k=null,z=null,we.set(0,0,i.canvas.width,i.canvas.height),O.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ie,disable:Ce,bindFramebuffer:Oe,drawBuffers:ye,useProgram:it,setBlending:y,setMaterial:Et,setFlipSided:We,setCullFace:Ze,setLineWidth:_e,setPolygonOffset:Ge,setScissorTest:Se,activeTexture:Fe,bindTexture:At,unbindTexture:S,compressedTexImage2D:m,compressedTexImage3D:Q,texImage2D:Ie,texImage3D:Z,updateUBOMapping:Be,uniformBlockBinding:re,texStorage2D:ae,texStorage3D:Ee,texSubImage2D:q,texSubImage3D:K,compressedTexSubImage2D:V,compressedTexSubImage3D:ve,scissor:ue,viewport:Te,reset:De}}function op(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new qe,A=new WeakMap;let h;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(S,m){return f?new OffscreenCanvas(S,m):qi("canvas")}function E(S,m,Q){let q=1;const K=At(S);if((K.width>Q||K.height>Q)&&(q=Q/Math.max(K.width,K.height)),q<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const V=Math.floor(q*K.width),ve=Math.floor(q*K.height);h===void 0&&(h=g(V,ve));const ae=m?g(V,ve):h;return ae.width=V,ae.height=ve,ae.getContext("2d").drawImage(S,0,0,V,ve),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+V+"x"+ve+")."),ae}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),S;return S}function p(S){return S.generateMipmaps}function u(S){i.generateMipmap(S)}function M(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(S,m,Q,q,K=!1){if(S!==null){if(i[S]!==void 0)return i[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let V=m;if(m===i.RED&&(Q===i.FLOAT&&(V=i.R32F),Q===i.HALF_FLOAT&&(V=i.R16F),Q===i.UNSIGNED_BYTE&&(V=i.R8)),m===i.RED_INTEGER&&(Q===i.UNSIGNED_BYTE&&(V=i.R8UI),Q===i.UNSIGNED_SHORT&&(V=i.R16UI),Q===i.UNSIGNED_INT&&(V=i.R32UI),Q===i.BYTE&&(V=i.R8I),Q===i.SHORT&&(V=i.R16I),Q===i.INT&&(V=i.R32I)),m===i.RG&&(Q===i.FLOAT&&(V=i.RG32F),Q===i.HALF_FLOAT&&(V=i.RG16F),Q===i.UNSIGNED_BYTE&&(V=i.RG8)),m===i.RG_INTEGER&&(Q===i.UNSIGNED_BYTE&&(V=i.RG8UI),Q===i.UNSIGNED_SHORT&&(V=i.RG16UI),Q===i.UNSIGNED_INT&&(V=i.RG32UI),Q===i.BYTE&&(V=i.RG8I),Q===i.SHORT&&(V=i.RG16I),Q===i.INT&&(V=i.RG32I)),m===i.RGB_INTEGER&&(Q===i.UNSIGNED_BYTE&&(V=i.RGB8UI),Q===i.UNSIGNED_SHORT&&(V=i.RGB16UI),Q===i.UNSIGNED_INT&&(V=i.RGB32UI),Q===i.BYTE&&(V=i.RGB8I),Q===i.SHORT&&(V=i.RGB16I),Q===i.INT&&(V=i.RGB32I)),m===i.RGBA_INTEGER&&(Q===i.UNSIGNED_BYTE&&(V=i.RGBA8UI),Q===i.UNSIGNED_SHORT&&(V=i.RGBA16UI),Q===i.UNSIGNED_INT&&(V=i.RGBA32UI),Q===i.BYTE&&(V=i.RGBA8I),Q===i.SHORT&&(V=i.RGBA16I),Q===i.INT&&(V=i.RGBA32I)),m===i.RGB&&Q===i.UNSIGNED_INT_5_9_9_9_REV&&(V=i.RGB9_E5),m===i.RGBA){const ve=K?Dr:He.getTransfer(q);Q===i.FLOAT&&(V=i.RGBA32F),Q===i.HALF_FLOAT&&(V=i.RGBA16F),Q===i.UNSIGNED_BYTE&&(V=ve===Je?i.SRGB8_ALPHA8:i.RGBA8),Q===i.UNSIGNED_SHORT_4_4_4_4&&(V=i.RGBA4),Q===i.UNSIGNED_SHORT_5_5_5_1&&(V=i.RGB5_A1)}return(V===i.R16F||V===i.R32F||V===i.RG16F||V===i.RG32F||V===i.RGBA16F||V===i.RGBA32F)&&e.get("EXT_color_buffer_float"),V}function v(S,m){let Q;return S?m===null||m===Vn||m===Oi?Q=i.DEPTH24_STENCIL8:m===Mt?Q=i.DEPTH32F_STENCIL8:m===Ni&&(Q=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Vn||m===Oi?Q=i.DEPTH_COMPONENT24:m===Mt?Q=i.DEPTH_COMPONENT32F:m===Ni&&(Q=i.DEPTH_COMPONENT16),Q}function R(S,m){return p(S)===!0||S.isFramebufferTexture&&S.minFilter!==Ut&&S.minFilter!==nt?Math.log2(Math.max(m.width,m.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?m.mipmaps.length:1}function B(S){const m=S.target;m.removeEventListener("dispose",B),L(m),m.isVideoTexture&&A.delete(m)}function w(S){const m=S.target;m.removeEventListener("dispose",w),C(m)}function L(S){const m=n.get(S);if(m.__webglInit===void 0)return;const Q=S.source,q=d.get(Q);if(q){const K=q[m.__cacheKey];K.usedTimes--,K.usedTimes===0&&I(S),Object.keys(q).length===0&&d.delete(Q)}n.remove(S)}function I(S){const m=n.get(S);i.deleteTexture(m.__webglTexture);const Q=S.source,q=d.get(Q);delete q[m.__cacheKey],a.memory.textures--}function C(S){const m=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(m.__webglFramebuffer[q]))for(let K=0;K<m.__webglFramebuffer[q].length;K++)i.deleteFramebuffer(m.__webglFramebuffer[q][K]);else i.deleteFramebuffer(m.__webglFramebuffer[q]);m.__webglDepthbuffer&&i.deleteRenderbuffer(m.__webglDepthbuffer[q])}else{if(Array.isArray(m.__webglFramebuffer))for(let q=0;q<m.__webglFramebuffer.length;q++)i.deleteFramebuffer(m.__webglFramebuffer[q]);else i.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&i.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&i.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let q=0;q<m.__webglColorRenderbuffer.length;q++)m.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(m.__webglColorRenderbuffer[q]);m.__webglDepthRenderbuffer&&i.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const Q=S.textures;for(let q=0,K=Q.length;q<K;q++){const V=n.get(Q[q]);V.__webglTexture&&(i.deleteTexture(V.__webglTexture),a.memory.textures--),n.remove(Q[q])}n.remove(S)}let b=0;function W(){b=0}function k(){const S=b;return S>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),b+=1,S}function z(S){const m=[];return m.push(S.wrapS),m.push(S.wrapT),m.push(S.wrapR||0),m.push(S.magFilter),m.push(S.minFilter),m.push(S.anisotropy),m.push(S.internalFormat),m.push(S.format),m.push(S.type),m.push(S.generateMipmaps),m.push(S.premultiplyAlpha),m.push(S.flipY),m.push(S.unpackAlignment),m.push(S.colorSpace),m.join()}function J(S,m){const Q=n.get(S);if(S.isVideoTexture&&Se(S),S.isRenderTargetTexture===!1&&S.version>0&&Q.__version!==S.version){const q=S.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{oe(Q,S,m);return}}t.bindTexture(i.TEXTURE_2D,Q.__webglTexture,i.TEXTURE0+m)}function H(S,m){const Q=n.get(S);if(S.version>0&&Q.__version!==S.version){oe(Q,S,m);return}t.bindTexture(i.TEXTURE_2D_ARRAY,Q.__webglTexture,i.TEXTURE0+m)}function Y(S,m){const Q=n.get(S);if(S.version>0&&Q.__version!==S.version){oe(Q,S,m);return}t.bindTexture(i.TEXTURE_3D,Q.__webglTexture,i.TEXTURE0+m)}function P(S,m){const Q=n.get(S);if(S.version>0&&Q.__version!==S.version){ie(Q,S,m);return}t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture,i.TEXTURE0+m)}const ne={[Os]:i.REPEAT,[_n]:i.CLAMP_TO_EDGE,[Gs]:i.MIRRORED_REPEAT},le={[Ut]:i.NEAREST,[gc]:i.NEAREST_MIPMAP_NEAREST,[er]:i.NEAREST_MIPMAP_LINEAR,[nt]:i.LINEAR,[Hr]:i.LINEAR_MIPMAP_NEAREST,[cn]:i.LINEAR_MIPMAP_LINEAR},pe={[vc]:i.NEVER,[yc]:i.ALWAYS,[Ic]:i.LESS,[Yo]:i.LEQUAL,[xc]:i.EQUAL,[Bc]:i.GEQUAL,[Sc]:i.GREATER,[Mc]:i.NOTEQUAL};function he(S,m){if(m.type===Mt&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===nt||m.magFilter===Hr||m.magFilter===er||m.magFilter===cn||m.minFilter===nt||m.minFilter===Hr||m.minFilter===er||m.minFilter===cn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,ne[m.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,ne[m.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,ne[m.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,le[m.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,le[m.minFilter]),m.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,pe[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===Ut||m.minFilter!==er&&m.minFilter!==cn||m.type===Mt&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||n.get(m).__currentAnisotropy){const Q=e.get("EXT_texture_filter_anisotropic");i.texParameterf(S,Q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),n.get(m).__currentAnisotropy=m.anisotropy}}}function we(S,m){let Q=!1;S.__webglInit===void 0&&(S.__webglInit=!0,m.addEventListener("dispose",B));const q=m.source;let K=d.get(q);K===void 0&&(K={},d.set(q,K));const V=z(m);if(V!==S.__cacheKey){K[V]===void 0&&(K[V]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,Q=!0),K[V].usedTimes++;const ve=K[S.__cacheKey];ve!==void 0&&(K[S.__cacheKey].usedTimes--,ve.usedTimes===0&&I(m)),S.__cacheKey=V,S.__webglTexture=K[V].texture}return Q}function O(S,m,Q){return Math.floor(Math.floor(S/Q)/m)}function j(S,m,Q,q){const V=S.updateRanges;if(V.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,m.width,m.height,Q,q,m.data);else{V.sort((Z,ue)=>Z.start-ue.start);let ve=0;for(let Z=1;Z<V.length;Z++){const ue=V[ve],Te=V[Z],Be=ue.start+ue.count,re=O(Te.start,m.width,4),De=O(ue.start,m.width,4);Te.start<=Be+1&&re===De&&O(Te.start+Te.count-1,m.width,4)===re?ue.count=Math.max(ue.count,Te.start+Te.count-ue.start):(++ve,V[ve]=Te)}V.length=ve+1;const ae=i.getParameter(i.UNPACK_ROW_LENGTH),Ee=i.getParameter(i.UNPACK_SKIP_PIXELS),Ie=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,m.width);for(let Z=0,ue=V.length;Z<ue;Z++){const Te=V[Z],Be=Math.floor(Te.start/4),re=Math.ceil(Te.count/4),De=Be%m.width,T=Math.floor(Be/m.width),ce=re,$=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,De),i.pixelStorei(i.UNPACK_SKIP_ROWS,T),t.texSubImage2D(i.TEXTURE_2D,0,De,T,ce,$,Q,q,m.data)}S.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ae),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ee),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ie)}}function oe(S,m,Q){let q=i.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),m.isData3DTexture&&(q=i.TEXTURE_3D);const K=we(S,m),V=m.source;t.bindTexture(q,S.__webglTexture,i.TEXTURE0+Q);const ve=n.get(V);if(V.version!==ve.__version||K===!0){t.activeTexture(i.TEXTURE0+Q);const ae=He.getPrimaries(He.workingColorSpace),Ee=m.colorSpace===St?null:He.getPrimaries(m.colorSpace),Ie=m.colorSpace===St||ae===Ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,m.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,m.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ie);let Z=E(m.image,!1,r.maxTextureSize);Z=Fe(m,Z);const ue=s.convert(m.format,m.colorSpace),Te=s.convert(m.type);let Be=x(m.internalFormat,ue,Te,m.colorSpace,m.isVideoTexture);he(q,m);let re;const De=m.mipmaps,T=m.isVideoTexture!==!0,ce=ve.__version===void 0||K===!0,$=V.dataReady,fe=R(m,Z);if(m.isDepthTexture)Be=v(m.format===ki,m.type),ce&&(T?t.texStorage2D(i.TEXTURE_2D,1,Be,Z.width,Z.height):t.texImage2D(i.TEXTURE_2D,0,Be,Z.width,Z.height,0,ue,Te,null));else if(m.isDataTexture)if(De.length>0){T&&ce&&t.texStorage2D(i.TEXTURE_2D,fe,Be,De[0].width,De[0].height);for(let ee=0,X=De.length;ee<X;ee++)re=De[ee],T?$&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,re.width,re.height,ue,Te,re.data):t.texImage2D(i.TEXTURE_2D,ee,Be,re.width,re.height,0,ue,Te,re.data);m.generateMipmaps=!1}else T?(ce&&t.texStorage2D(i.TEXTURE_2D,fe,Be,Z.width,Z.height),$&&j(m,Z,ue,Te)):t.texImage2D(i.TEXTURE_2D,0,Be,Z.width,Z.height,0,ue,Te,Z.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){T&&ce&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Be,De[0].width,De[0].height,Z.depth);for(let ee=0,X=De.length;ee<X;ee++)if(re=De[ee],m.format!==pt)if(ue!==null)if(T){if($)if(m.layerUpdates.size>0){const ge=io(re.width,re.height,m.format,m.type);for(const Ue of m.layerUpdates){const je=re.data.subarray(Ue*ge/re.data.BYTES_PER_ELEMENT,(Ue+1)*ge/re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,Ue,re.width,re.height,1,ue,je)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,re.width,re.height,Z.depth,ue,re.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ee,Be,re.width,re.height,Z.depth,0,re.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else T?$&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,re.width,re.height,Z.depth,ue,Te,re.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ee,Be,re.width,re.height,Z.depth,0,ue,Te,re.data)}else{T&&ce&&t.texStorage2D(i.TEXTURE_2D,fe,Be,De[0].width,De[0].height);for(let ee=0,X=De.length;ee<X;ee++)re=De[ee],m.format!==pt?ue!==null?T?$&&t.compressedTexSubImage2D(i.TEXTURE_2D,ee,0,0,re.width,re.height,ue,re.data):t.compressedTexImage2D(i.TEXTURE_2D,ee,Be,re.width,re.height,0,re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):T?$&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,re.width,re.height,ue,Te,re.data):t.texImage2D(i.TEXTURE_2D,ee,Be,re.width,re.height,0,ue,Te,re.data)}else if(m.isDataArrayTexture)if(T){if(ce&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,Be,Z.width,Z.height,Z.depth),$)if(m.layerUpdates.size>0){const ee=io(Z.width,Z.height,m.format,m.type);for(const X of m.layerUpdates){const ge=Z.data.subarray(X*ee/Z.data.BYTES_PER_ELEMENT,(X+1)*ee/Z.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,X,Z.width,Z.height,1,ue,Te,ge)}m.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,ue,Te,Z.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Be,Z.width,Z.height,Z.depth,0,ue,Te,Z.data);else if(m.isData3DTexture)T?(ce&&t.texStorage3D(i.TEXTURE_3D,fe,Be,Z.width,Z.height,Z.depth),$&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,ue,Te,Z.data)):t.texImage3D(i.TEXTURE_3D,0,Be,Z.width,Z.height,Z.depth,0,ue,Te,Z.data);else if(m.isFramebufferTexture){if(ce)if(T)t.texStorage2D(i.TEXTURE_2D,fe,Be,Z.width,Z.height);else{let ee=Z.width,X=Z.height;for(let ge=0;ge<fe;ge++)t.texImage2D(i.TEXTURE_2D,ge,Be,ee,X,0,ue,Te,null),ee>>=1,X>>=1}}else if(De.length>0){if(T&&ce){const ee=At(De[0]);t.texStorage2D(i.TEXTURE_2D,fe,Be,ee.width,ee.height)}for(let ee=0,X=De.length;ee<X;ee++)re=De[ee],T?$&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,ue,Te,re):t.texImage2D(i.TEXTURE_2D,ee,Be,ue,Te,re);m.generateMipmaps=!1}else if(T){if(ce){const ee=At(Z);t.texStorage2D(i.TEXTURE_2D,fe,Be,ee.width,ee.height)}$&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ue,Te,Z)}else t.texImage2D(i.TEXTURE_2D,0,Be,ue,Te,Z);p(m)&&u(q),ve.__version=V.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function ie(S,m,Q){if(m.image.length!==6)return;const q=we(S,m),K=m.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+Q);const V=n.get(K);if(K.version!==V.__version||q===!0){t.activeTexture(i.TEXTURE0+Q);const ve=He.getPrimaries(He.workingColorSpace),ae=m.colorSpace===St?null:He.getPrimaries(m.colorSpace),Ee=m.colorSpace===St||ve===ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,m.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,m.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const Ie=m.isCompressedTexture||m.image[0].isCompressedTexture,Z=m.image[0]&&m.image[0].isDataTexture,ue=[];for(let X=0;X<6;X++)!Ie&&!Z?ue[X]=E(m.image[X],!0,r.maxCubemapSize):ue[X]=Z?m.image[X].image:m.image[X],ue[X]=Fe(m,ue[X]);const Te=ue[0],Be=s.convert(m.format,m.colorSpace),re=s.convert(m.type),De=x(m.internalFormat,Be,re,m.colorSpace),T=m.isVideoTexture!==!0,ce=V.__version===void 0||q===!0,$=K.dataReady;let fe=R(m,Te);he(i.TEXTURE_CUBE_MAP,m);let ee;if(Ie){T&&ce&&t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,De,Te.width,Te.height);for(let X=0;X<6;X++){ee=ue[X].mipmaps;for(let ge=0;ge<ee.length;ge++){const Ue=ee[ge];m.format!==pt?Be!==null?T?$&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,ge,0,0,Ue.width,Ue.height,Be,Ue.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,ge,De,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):T?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,ge,0,0,Ue.width,Ue.height,Be,re,Ue.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,ge,De,Ue.width,Ue.height,0,Be,re,Ue.data)}}}else{if(ee=m.mipmaps,T&&ce){ee.length>0&&fe++;const X=At(ue[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,De,X.width,X.height)}for(let X=0;X<6;X++)if(Z){T?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,ue[X].width,ue[X].height,Be,re,ue[X].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,De,ue[X].width,ue[X].height,0,Be,re,ue[X].data);for(let ge=0;ge<ee.length;ge++){const je=ee[ge].image[X].image;T?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,ge+1,0,0,je.width,je.height,Be,re,je.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,ge+1,De,je.width,je.height,0,Be,re,je.data)}}else{T?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,0,0,Be,re,ue[X]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0,De,Be,re,ue[X]);for(let ge=0;ge<ee.length;ge++){const Ue=ee[ge];T?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,ge+1,0,0,Be,re,Ue.image[X]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+X,ge+1,De,Be,re,Ue.image[X])}}}p(m)&&u(i.TEXTURE_CUBE_MAP),V.__version=K.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function Ce(S,m,Q,q,K,V){const ve=s.convert(Q.format,Q.colorSpace),ae=s.convert(Q.type),Ee=x(Q.internalFormat,ve,ae,Q.colorSpace),Ie=n.get(m),Z=n.get(Q);if(Z.__renderTarget=m,!Ie.__hasExternalTextures){const ue=Math.max(1,m.width>>V),Te=Math.max(1,m.height>>V);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?t.texImage3D(K,V,Ee,ue,Te,m.depth,0,ve,ae,null):t.texImage2D(K,V,Ee,ue,Te,0,ve,ae,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),Ge(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,K,Z.__webglTexture,0,_e(m)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,K,Z.__webglTexture,V),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Oe(S,m,Q){if(i.bindRenderbuffer(i.RENDERBUFFER,S),m.depthBuffer){const q=m.depthTexture,K=q&&q.isDepthTexture?q.type:null,V=v(m.stencilBuffer,K),ve=m.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=_e(m);Ge(m)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ae,V,m.width,m.height):Q?i.renderbufferStorageMultisample(i.RENDERBUFFER,ae,V,m.width,m.height):i.renderbufferStorage(i.RENDERBUFFER,V,m.width,m.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ve,i.RENDERBUFFER,S)}else{const q=m.textures;for(let K=0;K<q.length;K++){const V=q[K],ve=s.convert(V.format,V.colorSpace),ae=s.convert(V.type),Ee=x(V.internalFormat,ve,ae,V.colorSpace),Ie=_e(m);Q&&Ge(m)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ie,Ee,m.width,m.height):Ge(m)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ie,Ee,m.width,m.height):i.renderbufferStorage(i.RENDERBUFFER,Ee,m.width,m.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ye(S,m){if(m&&m.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=n.get(m.depthTexture);q.__renderTarget=m,(!q.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),J(m.depthTexture,0);const K=q.__webglTexture,V=_e(m);if(m.depthTexture.format===Gi)Ge(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0,V):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0);else if(m.depthTexture.format===ki)Ge(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0,V):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0);else throw new Error("Unknown depthTexture format")}function it(S){const m=n.get(S),Q=S.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==S.depthTexture){const q=S.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),q){const K=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,q.removeEventListener("dispose",K)};q.addEventListener("dispose",K),m.__depthDisposeCallback=K}m.__boundDepthTexture=q}if(S.depthTexture&&!m.__autoAllocateDepthBuffer){if(Q)throw new Error("target.depthTexture not supported in Cube render targets");const q=S.texture.mipmaps;q&&q.length>0?ye(m.__webglFramebuffer[0],S):ye(m.__webglFramebuffer,S)}else if(Q){m.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer[q]),m.__webglDepthbuffer[q]===void 0)m.__webglDepthbuffer[q]=i.createRenderbuffer(),Oe(m.__webglDepthbuffer[q],S,!1);else{const K=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,V=m.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,V),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,V)}}else{const q=S.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=i.createRenderbuffer(),Oe(m.__webglDepthbuffer,S,!1);else{const K=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,V=m.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,V),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,V)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function rt(S,m,Q){const q=n.get(S);m!==void 0&&Ce(q.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),Q!==void 0&&it(S)}function Ve(S){const m=S.texture,Q=n.get(S),q=n.get(m);S.addEventListener("dispose",w);const K=S.textures,V=S.isWebGLCubeRenderTarget===!0,ve=K.length>1;if(ve||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=m.version,a.memory.textures++),V){Q.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(m.mipmaps&&m.mipmaps.length>0){Q.__webglFramebuffer[ae]=[];for(let Ee=0;Ee<m.mipmaps.length;Ee++)Q.__webglFramebuffer[ae][Ee]=i.createFramebuffer()}else Q.__webglFramebuffer[ae]=i.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){Q.__webglFramebuffer=[];for(let ae=0;ae<m.mipmaps.length;ae++)Q.__webglFramebuffer[ae]=i.createFramebuffer()}else Q.__webglFramebuffer=i.createFramebuffer();if(ve)for(let ae=0,Ee=K.length;ae<Ee;ae++){const Ie=n.get(K[ae]);Ie.__webglTexture===void 0&&(Ie.__webglTexture=i.createTexture(),a.memory.textures++)}if(S.samples>0&&Ge(S)===!1){Q.__webglMultisampledFramebuffer=i.createFramebuffer(),Q.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer);for(let ae=0;ae<K.length;ae++){const Ee=K[ae];Q.__webglColorRenderbuffer[ae]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,Q.__webglColorRenderbuffer[ae]);const Ie=s.convert(Ee.format,Ee.colorSpace),Z=s.convert(Ee.type),ue=x(Ee.internalFormat,Ie,Z,Ee.colorSpace,S.isXRRenderTarget===!0),Te=_e(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,Te,ue,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.RENDERBUFFER,Q.__webglColorRenderbuffer[ae])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(Q.__webglDepthRenderbuffer=i.createRenderbuffer(),Oe(Q.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(V){t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),he(i.TEXTURE_CUBE_MAP,m);for(let ae=0;ae<6;ae++)if(m.mipmaps&&m.mipmaps.length>0)for(let Ee=0;Ee<m.mipmaps.length;Ee++)Ce(Q.__webglFramebuffer[ae][Ee],S,m,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Ee);else Ce(Q.__webglFramebuffer[ae],S,m,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);p(m)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ve){for(let ae=0,Ee=K.length;ae<Ee;ae++){const Ie=K[ae],Z=n.get(Ie);t.bindTexture(i.TEXTURE_2D,Z.__webglTexture),he(i.TEXTURE_2D,Ie),Ce(Q.__webglFramebuffer,S,Ie,i.COLOR_ATTACHMENT0+ae,i.TEXTURE_2D,0),p(Ie)&&u(i.TEXTURE_2D)}t.unbindTexture()}else{let ae=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ae=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,q.__webglTexture),he(ae,m),m.mipmaps&&m.mipmaps.length>0)for(let Ee=0;Ee<m.mipmaps.length;Ee++)Ce(Q.__webglFramebuffer[Ee],S,m,i.COLOR_ATTACHMENT0,ae,Ee);else Ce(Q.__webglFramebuffer,S,m,i.COLOR_ATTACHMENT0,ae,0);p(m)&&u(ae),t.unbindTexture()}S.depthBuffer&&it(S)}function y(S){const m=S.textures;for(let Q=0,q=m.length;Q<q;Q++){const K=m[Q];if(p(K)){const V=M(S),ve=n.get(K).__webglTexture;t.bindTexture(V,ve),u(V),t.unbindTexture()}}}const Et=[],We=[];function Ze(S){if(S.samples>0){if(Ge(S)===!1){const m=S.textures,Q=S.width,q=S.height;let K=i.COLOR_BUFFER_BIT;const V=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ve=n.get(S),ae=m.length>1;if(ae)for(let Ie=0;Ie<m.length;Ie++)t.bindFramebuffer(i.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ie,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ve.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ie,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ve.__webglMultisampledFramebuffer);const Ee=S.texture.mipmaps;Ee&&Ee.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ve.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ve.__webglFramebuffer);for(let Ie=0;Ie<m.length;Ie++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),ae){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ve.__webglColorRenderbuffer[Ie]);const Z=n.get(m[Ie]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Z,0)}i.blitFramebuffer(0,0,Q,q,0,0,Q,q,K,i.NEAREST),c===!0&&(Et.length=0,We.length=0,Et.push(i.COLOR_ATTACHMENT0+Ie),S.depthBuffer&&S.resolveDepthBuffer===!1&&(Et.push(V),We.push(V),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,We)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Et))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ae)for(let Ie=0;Ie<m.length;Ie++){t.bindFramebuffer(i.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ie,i.RENDERBUFFER,ve.__webglColorRenderbuffer[Ie]);const Z=n.get(m[Ie]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ve.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ie,i.TEXTURE_2D,Z,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ve.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&c){const m=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[m])}}}function _e(S){return Math.min(r.maxSamples,S.samples)}function Ge(S){const m=n.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function Se(S){const m=a.render.frame;A.get(S)!==m&&(A.set(S,m),S.update())}function Fe(S,m){const Q=S.colorSpace,q=S.format,K=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||Q!==Wn&&Q!==St&&(He.getTransfer(Q)===Je?(q!==pt||K!==ct)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",Q)),m}function At(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(l.width=S.naturalWidth||S.width,l.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(l.width=S.displayWidth,l.height=S.displayHeight):(l.width=S.width,l.height=S.height),l}this.allocateTextureUnit=k,this.resetTextureUnits=W,this.setTexture2D=J,this.setTexture2DArray=H,this.setTexture3D=Y,this.setTextureCube=P,this.rebindTextures=rt,this.setupRenderTarget=Ve,this.updateRenderTargetMipmap=y,this.updateMultisampleRenderTarget=Ze,this.setupDepthRenderbuffer=it,this.setupFrameBufferTexture=Ce,this.useMultisampledRTT=Ge}function lp(i,e){function t(n,r=St){let s;const a=He.getTransfer(r);if(n===ct)return i.UNSIGNED_BYTE;if(n===ca)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Aa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Vo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Ho)return i.BYTE;if(n===zo)return i.SHORT;if(n===Ni)return i.UNSIGNED_SHORT;if(n===la)return i.INT;if(n===Vn)return i.UNSIGNED_INT;if(n===Mt)return i.FLOAT;if(n===qt)return i.HALF_FLOAT;if(n===Wo)return i.ALPHA;if(n===qo)return i.RGB;if(n===pt)return i.RGBA;if(n===Gi)return i.DEPTH_COMPONENT;if(n===ki)return i.DEPTH_STENCIL;if(n===Pn)return i.RED;if(n===ha)return i.RED_INTEGER;if(n===Nn)return i.RG;if(n===ua)return i.RG_INTEGER;if(n===da)return i.RGBA_INTEGER;if(n===fi||n===On||n===pi||n===Gn)if(a===Je)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===fi)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===On)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===pi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Gn)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===fi)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===On)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===pi)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Gn)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===wr||n===ks||n===Tr||n===Hs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===wr)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ks)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Tr)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Hs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===br||n===Hi||n===zi)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===br||n===Hi)return a===Je?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===zi)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===kn||n===zs||n===Vs||n===Ws||n===Vi||n===qs||n===Xs||n===Ys||n===Js||n===Ks||n===Zs||n===js||n===$s||n===ea)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===kn)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===zs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Vs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ws)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Vi)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===qs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Xs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ys)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Js)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ks)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Zs)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===js)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===$s)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ea)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Hn||n===ta||n===Rr)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Hn)return a===Je?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ta)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Rr)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Xo||n===na||n===ia||n===ra)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Hn)return s.COMPRESSED_RED_RGTC1_EXT;if(n===na)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ia)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ra)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Oi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const cp=`
void main() {
